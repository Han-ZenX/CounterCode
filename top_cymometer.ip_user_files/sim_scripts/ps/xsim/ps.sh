...
simulate()
{
  xsim ps -key {Behavioral:sim_1:Functional:ps} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af51.protoinst" -protoinst "protoinst_files/ps.protoinst" -log simulate.log
}
