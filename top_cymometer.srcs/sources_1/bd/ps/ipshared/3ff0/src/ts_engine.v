...
module ts_engine #(
    ...
    // Signal under test, asynchronous. counter_core may feed the divide-by-4
    // prescaled version here instead of the raw input; this module cannot tell
    // the difference and software scales the result back up.
    input  wire        clk_fx,
